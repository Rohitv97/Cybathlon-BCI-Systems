...
def network_train(X_train, X_test, y_train, y_test, X_eval, y_eval, X_eval2=None, y_eval2=None, mode='normal'):
    """
    Training out model
    ...
    :params: mode = normal for first two days and final for last day (as testing is different)
    """
    if mode == 'final':
        X_eval1 = X_eval
        y_eval1 = y_eval
        ...
        ### Train the network for 50 times and take average results
