...
### Essential Libraries
* MNE, scikit-learn, tensorflow, numpy, pandas and others.

### Datasets Used
* Graz 2A from BCI Competition IV. This is an open source dataset and can be found online.
...
### Development IPYNB
* This folder contains IPython notebooks of various approaches such as FBCSP, EEGNEt and NSL in the development stages
* Use these scripts to understand how the methods run. In case of any troubles understanding, you may send me an email.
